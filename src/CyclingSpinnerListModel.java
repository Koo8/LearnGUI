 ...
 * The Spinner_Date_ColorChange.java use the CyclingSpinnerListModel for
 * a month spinner that (is tied to the year spinner)
 * so that -- for example -- when the month
 * changes from December to January, the year increases.
 *
 * This program exists because standard spinner models do not support cycling
 */
public class CyclingSpinnerListModel extends SpinnerListModel {
   ...
   public void setLinkedModel(SpinnerModel linkedModel) {
        System.out.println("linkedModel is set");

        this.linkedModel = linkedModel;
    }
    // override getNextValue and getPreviousValue to achieve the continuously cycling feature

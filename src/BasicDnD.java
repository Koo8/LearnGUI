...
public class BasicDnD extends JPanel implements ActionListener {
    ...
    public BasicDnD() {
        ...
        list.setVisibleRowCount(-1);  // no difference with or without
        ...
        list.setTransferHandler(new TransferHandler() {
            ...
            public boolean canImport(TransferHandler.TransferSupport info) {
                ...
                if (dl.getIndex() == -1) {  // can't drop outside of the list container
                    return false;
                }
                return true;
            }
            ...
            public boolean importData(TransferHandler.TransferSupport info) {
                if (!info.isDrop()) {  // only when "drop" operation from TransferSupport
                    return false;
                }
            ...
            protected Transferable createTransferable(JComponent c) {
                ...
                // create a Transferable capable of transfer String
